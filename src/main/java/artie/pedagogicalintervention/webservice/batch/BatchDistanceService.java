...
public class BatchDistanceService {
    ...
    public void process(){
        ...
        Page<PedagogicalSoftwareData> page = null;
        Pageable pageable = PageRequest.of(pageNumber, PAGE_SIZE);

        // Walking through the pages
        do {
            page = softwareService.findAllPaginated(pageable);
            log.info("Found {} elements", page.getTotalElements());
            for (PedagogicalSoftwareData psd : page.getContent()) {
            ...
            log.info("Paginating...{} of {}", pageNumber + 1, page.getTotalPages());
        } while (!page.isLast());
